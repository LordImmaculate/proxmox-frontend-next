...
export function PasswordForm({
  ...
  const onSubmit = form.handleSubmit(async (data) => {
    const promise = authClient.changePassword({
      currentPassword: data.currentPassword,
      newPassword: data.newPassword,
      revokeOtherSessions: data.destroySessions
    });
    toast.promise(
      promise.then((result) => {
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid}>
              <FieldLabel htmlFor="form-rhf-demo-current-password">
                Current Password
              </FieldLabel>
              <Input
                {...field}
                id="form-rhf-demo-current-password"
