...
> = {
  ...
  meta: {
    modelProps: "user" | "session" | "account" | "verification" | "vm";
    ...
    Vm: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.VmCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type VmScalarFieldEnum =
  (typeof VmScalarFieldEnum)[keyof typeof VmScalarFieldEnum];
